...
namespace Prime31 {
    ...
    public class CharacterController2D : MonoBehaviour
    {
        ...
        public void move(Vector3 deltaMovement, bool isGravityDown)
        {
            ...
            {
                collisionState.wasGroundedLastFrame = collisionState.above;
            }
        ...
        public void warpToGrounded()
        {
            do
            {
                move(new Vector3(0, -1f, 0), _isGravityDown);
            } while (!isGrounded);
        }
        ...
        void moveHorizontally(ref Vector3 deltaMovement)
        {
            ...
            if (!_isGravityDown)
            {
                initialRayOrigin = isGoingRight ? _raycastOrigins.topRight : _raycastOrigins.topLeft;
            }
        ...
        void moveVertically(ref Vector3 deltaMovement)
        {
            ...
            var isGoingOppositeToGravity = deltaMovement.y > 0;
            if (!_isGravityDown)
            {
                isGoingOppositeToGravity = deltaMovement.y < 0;
            }
            ...
            if ((isGoingOppositeToGravity && !collisionState.wasGroundedLastFrame) || ignoreOneWayPlatformsThisFrame)
            {
